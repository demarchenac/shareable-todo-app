...
function Calendar({
  ...
  dayTooltips?: Record<string, string>
}) {
    ...
    <TooltipProvider delay={200}>
      <DayPicker
        ...
        classNames={{
          ...
          today: cn(
            'border-primary rounded-md border border-dashed',
        ...
        components={{
          ...
          DayButton: (props) => (
            <CalendarDayButton {...props} dayTooltips={dayTooltips} />
          ),
...
function CalendarDayButton({
  ...
  const tooltipContent = dayTooltips?.[dateKey] || 'No todos'
